...
namespace projekt_Jan_Machalski
{
    ...
    public class PassengerPlane: Plane
    {
        ...
        public PassengerPlane(UInt64 id, string serial, string country, string model, UInt16 firstClassSize, UInt16 buisnessClassSize, UInt16 economyClassSize):base(id, serial, country, model)    
        {
