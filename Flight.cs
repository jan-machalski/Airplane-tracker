...
namespace projekt_Jan_Machalski
{
    ...
    public class Flight: AviationObject
    {
        ...
        public Flight(UInt64 id,UInt64 originID, UInt64 targetID, string takeOffTime, string landingTime, Single longitude, Single latitude, Single amsl, UInt64 planeID, UInt64[] crewIDs, UInt64[] loadIDs):base(id)
        {
            OriginID = originID;
            TargetID = targetID;
